...
angular.module('xeditable').factory('editableController', 
  ...
  function EditableController($scope, $attrs, $element, $parse, editableThemes, editableOptions, $rootScope, $compile, $q) {
     ...
     * control.  
     * For example, if you set `<span editable-text="account.name" e-style="width: 100px"`>
...
angular.module('xeditable').factory('editableThemes', function() {
  var themes = {
    ...
    'bs3': {
      ...
      errorTpl:    '<div class="editable-error help-block" ng-show="$error" ng-bind="$error"></div>',
      buttonsTpl:  '<span class="editable-buttons"></span>',
      submitTpl:   '<button type="submit" class="btn btn-primary waves-effect waves-button waves-float"><span class="glyphicon glyphicon-ok"></span></button>',
      cancelTpl:   '<button type="button" class="btn btn-default waves-effect waves-button waves-float" ng-click="$form.$cancel()">'+
