...
//        return "<i class=\"icon " + data.icon + " icon-large\"></i><p class=\"bold\">" + data.title + "</p><p><span>" + data.message + "</span><span class=\"light\">" + data.info + "</span></p>";
      ...
      successMessage2Theme: function(data) {
          return "<div class=\"icon\"><div class='errorMessageIconCenter'><i class='fa fa-check corpo-error-circle animated infinite pulse icon-notification-error2'></i></div></div><div class=\"info2\">" + data.message + "</div>";
      },
      ...
      successMessageTableTheme: function(data) {
          return "<i class='fa fa-check corpo-success-circle-table-packs-purchase animated infinite pulse icon-notification-error2';></i>";
      },
